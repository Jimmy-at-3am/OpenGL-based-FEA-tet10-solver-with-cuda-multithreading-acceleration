// =============================================================================
//  StepSlicer.cpp  --  new_TODO_04 B-rep section seam (LayerSlicer::sliceBRepPlane).
//
//  This is the ONLY translation unit permitted to include OCC headers. For
//  new_TODO_04 the body is a compiling STUB that returns false, so every caller
...
//  XY/XZ/YZ plane, edge -> ordered-loop assembly, units handling) lands in
//  new_TODO_04B; it will live entirely behind the HAS_OCCT guard below.
//
...
bool sliceBRepPlane(const BRepHandle& brep, int axis, float coord, double Ldiag,
                    Section& out) {
    // new_TODO_04B will replace this with the analytic OCC section path. Until
